    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5>
                    <i class="fa fa-pencil"></i> {{ edit ? $t('blogs.categories.edit') : $t('blogs.categories.add') }}
                </h5>
            </div>
                ...
                <form class="form-horizontal" @submit.prevent="save()">
                    ...
                    <div class="form-group">
                        <div class="col-sm-4 col-sm-offset-2">
                            <router-link :to="{name: 'blogs.categories.index'}" class="btn btn-white">
                                {{ $t('form.cancel') }}
                            </router-link>
...
//            this.form.submitting = true;
        ...
        create() {
            ...
            this.$http.post('/api/blogs/categories', this.blog)
                    .then(response => {
                        ...
                        this.$router.push({name: 'blogs.categories.index'})
                    })
                    .catch(error => {
                        this.$events.$emit('notify', {
                            type: 'warning',
        ...
        update() {
            this.$http.put('/api/blogs/categories/' + this.$route.params.id, this.blog)
                    .then(response => {
                        this.$router.push({name: 'blogs.categories.index'});
                        this.$events.$emit('notify', {
                            type: 'info',
        ...
        updateEditBlog() {
            axios.get('/api/blogs/categories/' + this.$route.params.id)
                    .then(response => {
