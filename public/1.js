...
var map = {
	"./+blogs/create.vue": 430,
	"./+blogs/index.vue": 431,
	"./+categories/create.vue": 432,
	"./+categories/index.vue": 433
};
...
var _vueClassComponent = __webpack_require__(22);

var _vueClassComponent2 = _interopRequireDefault(_vueClassComponent);

var _vueMultiselect = __webpack_require__(383);
    ...
    (0, _createClass3.default)(Create, [{
        ...
        value: function mounted() {
            ...
            this.$watch('edit', function () {
                ...
                _this.edit ? _this.updateEditPBlog() : false;
            });

            this.$watch('blog.title', function (title, val) {
                _this.blog.slug = title.toLowerCase().replace(/ /g, '-').replace(/[^\w-]+/g, '-');
            });

            this.$http.get(this.$store.state.config.api_url + 'sites').then(function (response) {
                _this.sites = response.data.data;
            });

            this.$http.get(this.$store.state.config.api_url + 'blogs/categories').then(function (response) {
        ...
        value: function create() {
            ...
            this.$http.post('/api/blogs', this.blog).then(function (response) {
                _this2.$events.$emit('notify', {
                    type: 'info',
                    title: 'Success !',
                    message: 'Your Blog Was Created Successfully!'
                });
                _this2.$router.push({ name: 'blogs.all' });
        ...
        value: function update() {
            ...
            this.$http.put('/api/blogs/' + this.$route.params.id, this.blog).then(function (response) {
                _this3.$router.push({ name: 'blogs.all' });
        ...
        key: 'updateEditBlog',
        value: function updateEditBlog() {
            var _this4 = this;

            axios.get('/api/blogs/' + this.$route.params.id).then(function (response) {
                _this4.blog = response.data.data;
        ...
        value: function updateSelectedCategory(data) {
...
var Blogs = (0, _vueClassComponent2.default)(_class = function () {
    function Blogs() {
...
var Create = (_dec = (0, _vueClassComponent2.default)({
    ...
    (0, _createClass3.default)(Create, [{
        ...
        value: function create() {
            ...
            this.$http.post('/api/blogs/categories', this.blog).then(function (response) {
                _this2.$events.$emit('notify', {
                    type: 'info',
                    title: 'Success !',
                    message: 'Your Blog Was Created Successfully!'
                });
                _this2.$router.push({ name: 'blogs.categories.index' });
            }).catch(function (error) {
                _this2.$events.$emit('notify', {
                    type: 'warning',
                    title: 'Warning !',
                    message: 'Please Check your category details!'
                });
                _this2.form.errors = error.data;
                _this2.form.submitting = false;
            });
        ...
        value: function update() {
            ...
            this.$http.put('/api/blogs/categories/' + this.$route.params.id, this.blog).then(function (response) {
                _this3.$router.push({ name: 'blogs.categories.index' });
                _this3.$events.$emit('notify', {
                    type: 'info',
                    title: 'Success !',
        ...
        value: function updateEditBlog() {
            ...
            axios.get('/api/blogs/categories/' + this.$route.params.id).then(function (response) {
                _this4.blog = response.data.data;
                _this4.$events.$emit('update-tinycme', response.data.data.content);
            });
        }
...
var Categories = (0, _vueClassComponent2.default)(_class = function () {
    function Categories() {
    ...
    (0, _createClass3.default)(Categories, [{
        ...
        value: function mounted() {
            var table = DataTable;
            table.url = '/api/blogs/categories';
            table.edit = 'blogs.categories.edit';
            table.delete = 'blogs.categories.delete';
            table.actions = '';
            table.columns = [{ data: 'id' }, { data: 'title' }, { data: 'slug' }, {
                render: function render(e, v, data) {
                    return data.status ? '<i class="fa fa-circle text-success"></i> active' : '<i class="fa fa-circle text-danger"></i> disabled';
...
Component.options.__file = "/home/badi/Desktop/Zix_Development/zix-api.zixdev.com/modules/Blog/Assets/admin/js/views/+blogs/create.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7baa7d04", Component.options)
  } else {
    hotAPI.reload("data-v-7baa7d04", Component.options)
  }
})()}
...
Component.options.__file = "/home/badi/Desktop/Zix_Development/zix-api.zixdev.com/modules/Blog/Assets/admin/js/views/+blogs/index.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0af76cfa", Component.options)
  } else {
    hotAPI.reload("data-v-0af76cfa", Component.options)
  }
})()}
...
Component.options.__file = "/home/badi/Desktop/Zix_Development/zix-api.zixdev.com/modules/Blog/Assets/admin/js/views/+categories/create.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] create.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-105636f5", Component.options)
  } else {
    hotAPI.reload("data-v-105636f5", Component.options)
  }
})()}
...
Component.options.__file = "/home/badi/Desktop/Zix_Development/zix-api.zixdev.com/modules/Blog/Assets/admin/js/views/+categories/index.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] index.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-d8379e2e", Component.options)
  } else {
    hotAPI.reload("data-v-d8379e2e", Component.options)
  }
})()}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_c('h5', [_vm._v(_vm._s(_vm.$t('blogs.index_title')))]), _vm._v(" "), _c('div', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-0af76cfa", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }), _vm._v(" " + _vm._s(_vm.edit ? _vm.$t('blogs.categories.edit') : _vm.$t('blogs.categories.add')) + "\n            ")])]), _vm._v(" "), _c('div', {
    staticClass: "ibox-content"
  }, [_c('form', {
    ...
    domProps: {
      "value": _vm._s(_vm.blog.title)
    },
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.blog.title = $event.target.value
      }
    }
    ...
    domProps: {
      "value": _vm._s(_vm.blog.slug)
    },
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.blog.slug = $event.target.value
      }
    }
    ...
    staticClass: "col-sm-2 control-label"
  }, [_vm._v("\n                        " + _vm._s(_vm.$t('table.parent_category')) + " :\n                    ")]), _vm._v(" "), _c('div', {
    staticClass: "col-sm-10"
  }, [_c('multiselect', {
    attrs: {
      "value": _vm.blog.parent,
      "options": _vm.categories,
      "track-by": 'id',
      "label": "title"
    },
    on: {
      "input": _vm.updateSelectedCategory
    }
  }), _vm._v(" "), (_vm.form.errors && _vm.form.errors.sites) ? _c('span', {
    staticClass: "help-block m-b-none text-danger"
  }, [_vm._v(_vm._s(_vm.form.errors.sites.toString()))]) : _vm._e()], 1)]), _vm._v(" "), _c('div', {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.blog.seo.title),
      expression: "blog.seo.title"
    }],
    staticClass: "form-control",
    attrs: {
      "type": "text",
    ...
    domProps: {
      "value": _vm._s(_vm.blog.seo.title)
    },
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.blog.seo.title = $event.target.value
      }
    }
  })])]), _vm._v(" "), _c('div', {
    staticClass: "hr-line-dashed"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.blog.seo.keywords),
      expression: "blog.seo.keywords"
    }],
    staticClass: "form-control",
    attrs: {
      "type": "text",
    ...
    domProps: {
      "value": _vm._s(_vm.blog.seo.keywords)
    },
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.blog.seo.keywords = $event.target.value
      }
    }
  })])]), _vm._v(" "), _c('div', {
    staticClass: "hr-line-dashed"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.blog.seo.description),
      expression: "blog.seo.description"
    }],
    staticClass: "form-control",
    attrs: {
      "type": "text",
    ...
    domProps: {
      "value": _vm._s(_vm.blog.seo.description)
    },
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.blog.seo.description = $event.target.value
      }
    }
  })])]), _vm._v(" "), _c('div', {
    staticClass: "hr-line-dashed"
    ...
    domProps: {
      "checked": Array.isArray(_vm.blog.status) ? _vm._i(_vm.blog.status, null) > -1 : (_vm.blog.status)
    },
    on: {
      "click": function($event) {
        var $$a = _vm.blog.status,
          $$el = $event.target,
        ...
        if (Array.isArray($$a)) {
          var $$v = null,
            $$i = _vm._i($$a, $$v);
          if ($$c) {
            $$i < 0 && (_vm.blog.status = $$a.concat($$v))
          } else {
            $$i > -1 && (_vm.blog.status = $$a.slice(0, $$i).concat($$a.slice($$i + 1)))
          }
        } else {
          _vm.blog.status = $$c
        }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-105636f5", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "fa fa-pencil"
  }), _vm._v(" " + _vm._s(_vm.edit ? _vm.$t('blogs.edit') : _vm.$t('blogs.add')) + "\n            ")])]), _vm._v(" "), _c('div', {
    staticClass: "ibox-content"
  }, [_c('form', {
    staticClass: "form-horizontal",
    on: {
    ...
    staticClass: "col-sm-2 control-label"
  }, [_vm._v("\n                        " + _vm._s(_vm.$t('table.publish_at')) + " :\n                    ")]), _vm._v(" "), _c('div', {
    staticClass: "col-sm-10"
  }, [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.blog.published_at),
      expression: "blog.published_at"
    }],
    staticClass: "form-control",
    attrs: {
      "type": "date",
    ...
    domProps: {
      "value": _vm._s(_vm.blog.published_at)
    },
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.blog.published_at = $event.target.value
      }
    }
  }), _vm._v(" "), (_vm.form.errors && _vm.form.errors.published_at) ? _c('span', {
    staticClass: "help-block m-b-none text-danger"
  }, [_vm._v(_vm._s(_vm.form.errors.published_at.toString()))]) : _vm._e()])]), _vm._v(" "), _c('div', {
    staticClass: "hr-line-dashed"
  }), _vm._v(" "), _c('div', {
    staticClass: "form-group"
  }, [_c('label', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-7baa7d04", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "ibox-title"
  }, [_c('h5', [_vm._v(_vm._s(_vm.$t('blogs.categories.index_title')))]), _vm._v(" "), _c('div', {
    staticClass: "ibox-tools"
  }, [_c('router-link', {
    staticClass: "btn btn-success",
    attrs: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-d8379e2e", module.exports)
  }
}
